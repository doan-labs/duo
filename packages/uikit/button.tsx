...
/** Native button: tinted capsule by default, filled with the link colour, or plain text. Icon-only buttons need aria-label. */
...
const styles = stylex.create({
  filled: { backgroundColor: app.link, color: colors.white },
  control: {
    outlineOffset: 3,
