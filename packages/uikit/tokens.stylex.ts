...
export const appAppearance = stylex.defineConsts({
  ...
  appstoreRadius16: '16px',
  appstoreRadius18: '18px',
  appstoreRadius26: '26px',
  ...
  appstoreFontSize16: '16px',
  appstoreFontSize17: '17px',
  appstoreFontSize20: '20px',
  ...
  appstoreHeroShadow: '0 10px 30px rgba(0,0,0,.18)',
  appstoreHeroBarBackground: 'rgba(0,0,0,.28)',
  ...
  appstoreDetailIconShadow: '0 6px 18px rgba(0,0,0,.16)',
  appstorePillLightBackground: 'rgba(255,255,255,.22)',
  mailFontSize: '22px',
