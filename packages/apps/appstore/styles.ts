...
export const styles = stylex.create({
  ...
  chipDot: { width: 6, height: 6, borderRadius: 3, backgroundColor: colors.green, flexShrink: 0 },
  ...
  segOn: { backgroundColor: colors.white, boxShadow: '0 1px 4px rgba(0,0,0,.12)' },
  /** Featured card. */
  hero: {
    display: 'block',
    width: 'calc(100% - 32px)',
  ...
  kicker: { fontSize: 11, fontWeight: 700, letterSpacing: 1.1, opacity: 0.85, textTransform: 'uppercase' },
  heroName: { fontSize: 26, fontWeight: 800, lineHeight: 1.1, letterSpacing: -0.4, marginTop: 6 },
  heroBlurb: { fontSize: 14, opacity: 0.9, marginTop: 4 },
  heroBar: {
    display: 'flex',
    alignItems: 'center',
    gap: 12,
  ...
  heroIcon: { width: 44, height: 44, borderRadius: 10, flexShrink: 0, boxShadow: '0 2px 8px rgba(0,0,0,.3)' },
  ...
  hCount: { fontSize: 13, fontWeight: 500, color: colors.grey },
  /** App row. */
  item: {
    display: 'flex',
    alignItems: 'center',
  ...
  perms: { display: 'flex', alignItems: 'center', gap: 6, color: colors.grey, marginTop: 2, fontSize: 11 },
  tag: {
    display: 'inline-flex',
    alignItems: 'center',
    gap: 3,
  ...
  ringHole: { width: 18, height: 18, borderRadius: 9, backgroundColor: colors.white },
  ...
  dIcon: { width: 112, height: 112, borderRadius: 26, fontSize: 44, boxShadow: '0 6px 18px rgba(0,0,0,.16)' },
  dInfo: { flexGrow: 1, minWidth: 0, display: 'flex', flexDirection: 'column', minHeight: 112 },
  dName: { fontSize: 22, fontWeight: 700, letterSpacing: -0.3, lineHeight: 1.15 },
  ...
  pillLight: { backgroundColor: 'rgba(255,255,255,.22)', color: colors.white },
