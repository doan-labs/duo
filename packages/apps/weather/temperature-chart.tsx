import { appAppearance, colors, leading, typeScale } from '@doan-labs/duo-uikit/tokens.stylex.ts'
...
const styles = stylex.create({
  ...
  line: {
    fill: 'none',
    stroke: appAppearance.weatherSun,
    strokeWidth: 3,
    strokeLinecap: 'round',
    strokeLinejoin: 'round'
  },
  label: { fill: colors.white, opacity: 0.7, fontSize: typeScale.caption2, lineHeight: leading.caption2 }
})
