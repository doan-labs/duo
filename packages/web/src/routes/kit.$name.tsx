...
const styles = stylex.create({
  ...
  crumb: { color: { default: color.text3, ':hover': color.text }, textDecoration: 'none' },
  ...
  doc: { marginTop: '24px', fontSize: '17px', lineHeight: 1.6, color: color.text },
  h2: {
    marginTop: '40px',
    marginBottom: '16px',
    paddingTop: '32px',
  ...
  related: {
    display: 'grid',
    gridTemplateColumns: { default: 'repeat(3, minmax(0, 1fr))', '@media (max-width: 734px)': '1fr' },
    gap: '12px',
    marginBottom: '40px'
  },
  tile: {
  ...
  tileName: { fontFamily: font.display, fontSize: '16px', fontWeight: 600 },
