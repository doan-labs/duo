...
| `storyboard: yes`                                                                                                 | `../references/storyboard-format.md` and `../references/review-loop.md`                                                                                                                                        |
...
| Multi-scene assembly                                                                                              | `../references/production-loop.md`                                                                                                                                                                                         |
| `flow: companion`, before the first plan                                                                          | `/hyperframes-creative` → `references/story-spine.md` and `references/house-style.md`; the nearest genre lens and the full `../references/capability-menu.md` — the ceiling treatment is designed from these, not recalled |
| A companion capability offer, capture, beat grid, generative video, map, publishing, or cross-workflow capability | `../references/capability-menu.md`                                                                                                                                                                                         |
...
After final approval, offer once to freeze the run as a recipe, following `../references/review-loop.md` § 4.
