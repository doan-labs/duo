...
description: >
  ...
  overlay, slideshow or interactive deck, or any HyperFrames HTML composition. Also
...
| -------- | ------------------------------------------------------------------------------------------------------------------ | -------------------------- |
| 1        | Author a presentation, pitch deck, or navigable interactive deck                                                   | `/slideshow`               |
| 2        | Add plain captions or subtitles to existing talking-head footage without changing it                               | `/embedded-captions`       |
| 3        | Add designed graphic overlays to existing talking-head, interview, or podcast footage without changing the footage | `/talking-head-recut`      |
| 4        | Build a beat-synced video from a music track, with no narration or website capture                                 | `/music-to-video`          |
| 5        | Create an explicitly short, unnarrated, motion-first unit, typically under 10s                                     | `/motion-graphics`         |
| 6        | Explain a GitHub pull request or code change from a PR reference                                                   | `/pr-to-video`             |
| 7        | Market or showcase a website, product site, app, or company from a URL or site-specific brief                      | `/product-launch-video`    |
| 8        | Explain a topic, article, or notes with invented visuals and no product or site capture                            | `/faceless-explainer`      |
| 9        | Any other custom video or composition                                                                              | `/general-video`           |
...
- Specialized narrative workflows support up to about 3 minutes and are strongest around 30–90s. Route a clearly longer piece to `/general-video`. Length never overrides a deck, caption, overlay, or music-driven deliverable.
