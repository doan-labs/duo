...
| --- | --- | --- |
| Browser AI builder | Implemented locally | Live local route at `/build` verified against the production build with streamed AI SDK fixtures; hosted CORS/MIME behavior, live providers and Safari need separate verification; [builder](builder.md) |
