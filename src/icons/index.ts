...
import contacts from './contacts.webp'
import facetime from './facetime.webp'
import findmy from './findmy.webp'
import freeform from './freeform.webp'
import home from './home.webp'
import mail from './mail.webp'
import maps from './maps.webp'
...
import photos from './photos.webp'
import podcasts from './podcasts.webp'
import preview from './preview.webp'
import reminders from './reminders.webp'
import safari from './safari.webp'
import settings from './settings.webp'
import shortcuts from './shortcuts.webp'
import siri from './siri.webp'
import stocks from './stocks.webp'
import tips from './tips.webp'
import tv from './tv.webp'
import voicememos from './voicememos.webp'
...
import airplane from './sym/airplane.webp'
import antenna from './sym/antenna-radiowaves-left-and-right.webp'
import reload from './sym/arrow-clockwise.webp'
import flip from './sym/arrow-triangle-2-circlepath-camera-fill.webp'
import expand from './sym/arrow-up-left-and-arrow-down-right.webp'
import undo from './sym/arrow-uturn-backward.webp'
import aspect from './sym/aspectratio.webp'
import battery from './sym/battery-100.webp'
import bolt from './sym/bolt-fill.webp'
import boltOff from './sym/bolt-slash-fill.webp'
import book from './sym/book-fill.webp'
import filters from './sym/camera-filters.webp'
import cellular from './sym/cellularbars.webp'
import checklist from './sym/checklist.webp'
import back from './sym/chevron-left.webp'
import forward from './sym/chevron-right.webp'
import up from './sym/chevron-up.webp'
import bluetooth from './sym/dot-radiowaves-left-and-right.webp'
import more from './sym/ellipsis-circle.webp'
import torchOff from './sym/flashlight-off-fill.webp'
import torchOn from './sym/flashlight-on-fill.webp'
import newFolder from './sym/folder-badge-plus.webp'
import folder from './sym/folder-fill.webp'
import gear from './sym/gear.webp'
import privacy from './sym/hand-raised-fill.webp'
import iphone from './sym/iphone.webp'
import live from './sym/livephoto.webp'
import location from './sym/location-fill.webp'
import lock from './sym/lock-fill.webp'
import search from './sym/magnifyingglass.webp'
import moon from './sym/moon-fill.webp'
import note from './sym/note-text.webp'
import markup from './sym/pencil-tip-crop-circle.webp'
import people from './sym/person-2-fill.webp'
import person from './sym/person-crop-circle.webp'
import plus from './sym/plus.webp'
import exposure from './sym/plusminus-circle.webp'
import sidebar from './sym/sidebar-left.webp'
import volume from './sym/speaker-wave-3-fill.webp'
import share from './sym/square-and-arrow-up.webp'
import compose from './sym/square-and-pencil.webp'
import grid from './sym/square-grid-3x3.webp'
import tabs from './sym/square-on-square.webp'
import sun from './sym/sun-max-fill.webp'
import table from './sym/tablecells.webp'
import trash from './sym/trash-fill.webp'
import wifi from './sym/wifi.webp'
import close from './sym/xmark.webp'
